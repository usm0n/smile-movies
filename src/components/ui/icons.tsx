...
export const MicOff = icon(L.MicOff);
export const Videocam = icon(L.Video);
export const VideocamOff = icon(L.VideoOff);
export const PhoneOff = icon(L.PhoneOff);
export const Smile = icon(L.Smile);
